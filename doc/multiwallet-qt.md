...
Only requiring some minor changes is lkcoin.cpp.
...
Changes to lkcoin.cpp
----------------------
lkcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
