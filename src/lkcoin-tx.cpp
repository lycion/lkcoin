...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Lkcoin Core lkcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lkcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lkcoin transaction") + "\n" +
              "  lkcoin-tx [options] -create [commands]   " + _("Create hex-encoded lkcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lkcoin transaction
