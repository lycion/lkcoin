...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Lkcoin features */
    { "lkcoin",               "masternode",             &masternode,             true,      true,       false },
    { "lkcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "lkcoin",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "lkcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "lkcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "lkcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "lkcoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "lkcoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "lkcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use lkcoind, or the -server option to lkcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> lkcoin-cli " + methodname + " " + args + "\n";
}
