    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Lkcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Lkcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lkcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Lkcoin Core is shutting down...") + "<br /><br />" +
