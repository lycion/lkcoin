    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Lkcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Lkcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lkcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Lkcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Lkcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Lkcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Lkcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Lkcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a lkcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Lkcoin Core help message to get a list with possible Lkcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Lkcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Lkcoin network", "", count));
}
...
{
    QString strTitle = tr("Lkcoin Core"); // default title
