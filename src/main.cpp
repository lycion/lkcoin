...
#if defined(NDEBUG)
# error "Lkcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in tnLKN) are considered zero fee (for relaying and mining)
