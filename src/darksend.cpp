...
/* *** BEGIN DARKSEND MAGIC - LKN **********
    Copyright (c) 2014-2015, Lkcoin Developers
        eduffield - evan@lkcoinpay.io
        udjinm6   - udjinm6@lkcoinpay.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Lkcoin and make it unusable. To
