...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 LKN, node2 has none. 
#   d) node0 sends 21 LKN to node2, in two transactions (11 LKN, then 10 LKN).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 LKN from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 LKN in block rewards plus fees, but
