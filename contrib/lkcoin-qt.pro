...
RESOURCES += src/qt/lkcoin.qrc src/qt/lkcoin_locale.qrc
TRANSLATIONS += src/qt/locale/lkcoin_bg.ts \
                src/qt/locale/lkcoin_de.ts \
                src/qt/locale/lkcoin_en.ts \
                src/qt/locale/lkcoin_es.ts \
                src/qt/locale/lkcoin_fi.ts \
                src/qt/locale/lkcoin_fr.ts \
                src/qt/locale/lkcoin_it.ts \
                src/qt/locale/lkcoin_ja.ts \
                src/qt/locale/lkcoin_pl.ts \
                src/qt/locale/lkcoin_pt.ts \
                src/qt/locale/lkcoin_ru.ts \
                src/qt/locale/lkcoin_sk.ts \
                src/qt/locale/lkcoin_sv.ts \
                src/qt/locale/lkcoin_vi.ts \
                src/qt/locale/lkcoin_zh_CN.ts \
                src/qt/locale/lkcoin_zh_TW.ts
